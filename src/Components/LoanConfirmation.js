    ...
    <div className="font-sans flex justify-center items-center min-h-screen bg-gray-100">
      ...
      <div className="font-sans bg-white shadow-md w-full max-w-md min-h-screen flex flex-col justify-center items-center">
        ...
        <div className="p-6 bg-green-50 text-[#5EB66E] rounded-md text-center w-4/5">
          <h1 className="font-sans text-2xl font-bold mb-2">Loan Request Submitted!</h1>
          <p className="font-sans text-[15px]"> We will review your application and get back to you shortly.</p>
